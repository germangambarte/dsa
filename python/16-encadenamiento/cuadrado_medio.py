...
class Tabla:
    ...
    def hash(self, elemento: int):
        ...
        long_elemento = len(str(numero))
        extraccion = (long_elemento - long_rango) // 2

        obtener_der = 10 ** extraccion
        obtener_izq = 10 ** (long_elemento - (extraccion * 2))

        medio = (elemento // obtener_der) % obtener_izq
